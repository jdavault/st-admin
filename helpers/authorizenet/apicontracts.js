...
class CustomerProfileIdType {
    ...
    setCustomerProfileId(p_customerProfileId) {
    ...
    setCustomerPaymentProfileId(p_customerPaymentProfileId) {
    ...
    setCustomerAddressId(p_customerAddressId) {
...
class CreditCardMaskedType {
    ...
    setExpirationDate(p_expirationDate) {
...
class ARBGetSubscriptionListSorting {
    ...
    setOrderDescending(p_orderDescending) {
...
class KeyValue {
    ...
    setEncryptionAlgorithm(p_EncryptionAlgorithm) {
...
class PaymentScheduleType {
    ...
    setTotalOccurrences(p_totalOccurrences) {
    ...
    setTrialOccurrences(p_trialOccurrences) {
...
class TransactionDetailsType {
    ...
    setSplitTenderId(p_splitTenderId) {
    ...
    setSubmitTimeUTC(p_submitTimeUTC) {
    ...
    setSubmitTimeLocal(p_submitTimeLocal) {
    ...
    setTransactionType(p_transactionType) {
    ...
    setTransactionStatus(p_transactionStatus) {
    ...
    setResponseCode(p_responseCode) {
    ...
    setResponseReasonCode(p_responseReasonCode) {
    ...
    setSubscription(p_subscription) {
    ...
    setResponseReasonDescription(p_responseReasonDescription) {
    ...
    setCardCodeResponse(p_cardCodeResponse) {
    ...
    setCAVVResponse(p_CAVVResponse) {
    ...
    setFDSFilterAction(p_FDSFilterAction) {
    ...
    setRequestedAmount(p_requestedAmount) {
    ...
    setSettleAmount(p_settleAmount) {
    ...
    setPrepaidBalanceRemaining(p_prepaidBalanceRemaining) {
    ...
    setRecurringBilling(p_recurringBilling) {
    ...
    setMobileDeviceId(p_mobileDeviceId) {
    ...
    setCustomerSignature(p_customerSignature) {
    ...
    setReturnedItems(p_returnedItems) {
...
class EnumCollection {
    ...
    setCustomerProfileSummaryType(p_customerProfileSummaryType) {
    ...
    setPaymentSimpleType(p_paymentSimpleType) {
    ...
    setAccountTypeEnum(p_accountTypeEnum) {
    ...
    setCardTypeEnum(p_cardTypeEnum) {
    ...
    setFDSFilterActionEnum(p_FDSFilterActionEnum) {
    ...
    setPermissionsEnum(p_permissionsEnum) {
    ...
    setSettingNameEnum(p_settingNameEnum) {
    ...
    setSettlementStateEnum(p_settlementStateEnum) {
    ...
    setTransactionStatusEnum(p_transactionStatusEnum) {
    ...
    setTransactionTypeEnum(p_transactionTypeEnum) {
...
class PaymentProfile {
    ...
    setPaymentProfileId(p_paymentProfileId) {
...
class ProfileTransVoidType {
    ...
    setCustomerShippingAddressId(p_customerShippingAddressId) {
...
class OrderType {
    ...
    setInvoiceNumber(p_invoiceNumber) {
...
class CustomerProfileBaseType {
    ...
    setMerchantCustomerId(p_merchantCustomerId) {
...
class EncryptedTrackDataType {
    ...
    setFormOfPayment(p_FormOfPayment) {
...
class BatchStatisticType {
    ...
    setChargeAmount(p_chargeAmount) {
    ...
    setRefundAmount(p_refundAmount) {
    ...
    setDeclineCount(p_declineCount) {
    ...
    setReturnedItemAmount(p_returnedItemAmount) {
    ...
    setReturnedItemCount(p_returnedItemCount) {
    ...
    setChargebackAmount(p_chargebackAmount) {
    ...
    setChargebackCount(p_chargebackCount) {
    ...
    setCorrectionNoticeCount(p_correctionNoticeCount) {
    ...
    setChargeChargeBackAmount(p_chargeChargeBackAmount) {
    ...
    setChargeChargeBackCount(p_chargeChargeBackCount) {
    ...
    setRefundChargeBackAmount(p_refundChargeBackAmount) {
    ...
    setRefundChargeBackCount(p_refundChargeBackCount) {
    ...
    setChargeReturnedItemsAmount(p_chargeReturnedItemsAmount) {
    ...
    setChargeReturnedItemsCount(p_chargeReturnedItemsCount) {
    ...
    setRefundReturnedItemsAmount(p_refundReturnedItemsAmount) {
    ...
    setRefundReturnedItemsCount(p_refundReturnedItemsCount) {
...
class PaymentDetails {
    ...
    setShippingHandling(p_shippingHandling) {
...
class TransactionSummaryType {
    ...
    setAccountNumber(p_accountNumber) {
    ...
    setHasReturnedItems(p_hasReturnedItems) {
...
class ArrayOfReturnedItem {
    ...
    setReturnedItem(p_returnedItem) {
...
class CustomerDataType {
    ...
    setDriversLicense(p_driversLicense) {
...
class TransactionResponse {
    ...
    setRawResponseCode(p_rawResponseCode) {
    ...
    setAvsResultCode(p_avsResultCode) {
    ...
    setCvvResultCode(p_cvvResultCode) {
    ...
    setCavvResultCode(p_cavvResultCode) {
    ...
    setSplitTenderPayments(p_splitTenderPayments) {
    ...
    setSecureAcceptance(p_secureAcceptance) {
...
class CardArt {
    ...
    setCardImageHeight(p_cardImageHeight) {
    ...
    setCardImageUrl(p_cardImageUrl) {
    ...
    setCardImageWidth(p_cardImageWidth) {
...
class ProfileTransactionType {
    ...
    setProfileTransAuthCapture(p_profileTransAuthCapture) {
    ...
    setProfileTransAuthOnly(p_profileTransAuthOnly) {
    ...
    setProfileTransPriorAuthCapture(p_profileTransPriorAuthCapture) {
    ...
    setProfileTransCaptureOnly(p_profileTransCaptureOnly) {
    ...
    setProfileTransRefund(p_profileTransRefund) {
    ...
    setProfileTransVoid(p_profileTransVoid) {
...
class ListOfAUDetailsType {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            if ((obj != undefined) && (obj != null)) {
                ...
                obj.forEach(function (item) {
                    auUpdateOrAuDeleteList.push(String(item));
                });
    ...
    setAuUpdateOrAuDelete(p_auUpdateOrAuDelete) {
...
class MerchantContactType {
    ...
    setMerchantName(p_merchantName) {
    ...
    setMerchantAddress(p_merchantAddress) {
    ...
    setMerchantCity(p_merchantCity) {
    ...
    setMerchantState(p_merchantState) {
    ...
    setMerchantPhone(p_merchantPhone) {
...
class BankAccountType {
    ...
    setRoutingNumber(p_routingNumber) {
    ...
    setNameOnAccount(p_nameOnAccount) {
...
class PayPalType {
    ...
    setPaypalHdrImg(p_paypalHdrImg) {
    ...
    setPaypalPayflowcolor(p_paypalPayflowcolor) {
...
class BatchDetailsType {
    ...
    setSettlementTimeUTC(p_settlementTimeUTC) {
    ...
    setSettlementTimeLocal(p_settlementTimeLocal) {
    ...
    setSettlementState(p_settlementState) {
    ...
    setPaymentMethod(p_paymentMethod) {
...
class CustomerProfilePaymentType {
    ...
    setCreateProfile(p_createProfile) {
    ...
    setPaymentProfile(p_paymentProfile) {
    ...
    setShippingProfileId(p_shippingProfileId) {
...
class PaymentMaskedType {
    ...
    setTokenInformation(p_tokenInformation) {
...
class PaymentType {
    ...
    setEncryptedTrackData(p_encryptedTrackData) {
...
class SubscriptionIdList {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            if ((obj != undefined) && (obj != null)) {
                ...
                obj.forEach(function (item) {
                    subscriptionIdList.push(String(item));
                });
    ...
    setSubscriptionId(p_subscriptionId) {
...
class SubscriptionDetail {
    ...
    setCreateTimeStampUTC(p_createTimeStampUTC) {
    ...
    setPastOccurrences(p_pastOccurrences) {
    ...
    setCustomerShippingProfileId(p_customerShippingProfileId) {
...
class ArrayOfNumericString {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            if ((obj != undefined) && (obj != null)) {
                ...
                obj.forEach(function (item) {
                    numericStringList.push(String(item));
                });
    ...
    setNumericString(p_numericString) {
...
class PaymentEmvType {
    ...
    setEmvDescriptor(p_emvDescriptor) {
...
class TransactionRequestType {
    ...
    setTerminalNumber(p_terminalNumber) {
    ...
    setCardholderAuthentication(p_cardholderAuthentication) {
    ...
    setTransactionSettings(p_transactionSettings) {
...
class CustomerPaymentProfileBaseType {
    ...
    setCustomerType(p_customerType) {
...
class CreateProfileResponse {
    ...
    setCustomerPaymentProfileIdList(p_customerPaymentProfileIdList) {
    ...
    setCustomerShippingAddressIdList(p_customerShippingAddressIdList) {
...
class ArrayOfSubscription {
    ...
    setSubscriptionDetail(p_subscriptionDetail) {
...
class AuResponseType {
    ...
    setAuReasonCode(p_auReasonCode) {
    ...
    setProfileCount(p_profileCount) {
    ...
    setReasonDescription(p_reasonDescription) {
...
class OpaqueDataType {
    ...
    setDataDescriptor(p_dataDescriptor) {
...
class CcAuthenticationType {
    ...
    setAuthenticationIndicator(p_authenticationIndicator) {
    ...
    setCardholderAuthenticationValue(p_cardholderAuthenticationValue) {
...
class MerchantAuthenticationType {
    ...
    setTransactionKey(p_transactionKey) {
    ...
    setImpersonationAuthentication(p_impersonationAuthentication) {
...
class PermissionType {
    ...
    setPermissionName(p_permissionName) {
...
class ARBSubscriptionType {
    ...
    setPaymentSchedule(p_paymentSchedule) {
...
class AuDetailsType {
    ...
    setUpdateTimeUTC(p_updateTimeUTC) {
...
class MobileDeviceType {
    ...
    setDevicePlatform(p_devicePlatform) {
    ...
    setDeviceActivation(p_deviceActivation) {
...
class SettingType {
    ...
    setSettingValue(p_settingValue) {
...
TransactionResponse.SecureAcceptance = class {
    ...
    setSecureAcceptanceUrl(p_SecureAcceptanceUrl) {
...
KeyManagementScheme.DUKPT = class {
    ...
    setEncryptedData(p_EncryptedData) {
...
TransactionResponse.PrePaidCard = class {
    ...
    setApprovedAmount(p_approvedAmount) {
    ...
    setBalanceOnCard(p_balanceOnCard) {
...
TransactionResponse.SplitTenderPayments = class {
    ...
    setSplitTenderPayment(p_splitTenderPayment) {
        this.splitTenderPayment = p_splitTenderPayment;
    }

    getSplitTenderPayment() {
...
TransactionResponse.SplitTenderPayments.SplitTenderPayment = class {
    ...
    setResponseToCustomer(p_responseToCustomer) {
...
class MobileDeviceLoginResponse extends ANetApiResponse {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('merchantContact' in obj) && (obj.merchantContact != null)) {
                this.setMerchantContact(new MerchantContactType(obj.merchantContact));
            }
            if (('userPermissions' in obj) && (obj.userPermissions != null)) {
                this.setUserPermissions(new ArrayOfPermissionType(obj.userPermissions));
            }
            if (('merchantAccount' in obj) && (obj.merchantAccount != null)) {
                this.setMerchantAccount(new TransRetailInfoType(obj.merchantAccount));
            }
        } else {
            super();
    ...
    setMerchantContact(p_merchantContact) {
    ...
    setUserPermissions(p_userPermissions) {
    ...
    setMerchantAccount(p_merchantAccount) {
    ...
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('transaction' in obj) && (obj.transaction != null)) {
                this.setTransaction(new TransactionDetailsType(obj.transaction));
            }
        } else {
            super();
            this.setTransaction(null);
...
class CustomerProfileType extends CustomerProfileBaseType {
    ...
    setPaymentProfiles(p_paymentProfiles) {
    ...
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('transactions' in obj) && (obj.transactions != null)) {
                this.setTransactions(new ArrayOfTransactionSummaryType(obj.transactions));
            }
        } else {
            super();
    ...
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('ids' in obj) && (obj.ids != null)) {
                this.setIds(new ArrayOfNumericString(obj.ids));
            }
        } else {
            super();
            this.setIds(null);
    ...
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('auSummary' in obj) && (obj.auSummary != null)) {
                this.setAuSummary(new ArrayOfAUResponseType(obj.auSummary));
            }
        } else {
            super();
...
class GetAUJobDetailsRequest extends ANetApiRequest {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('modifiedTypeFilter' in obj) && (obj.modifiedTypeFilter != null)) {
                this.setModifiedTypeFilter(obj.modifiedTypeFilter);
            }
            if (('paging' in obj) && (obj.paging != null)) {
                this.setPaging(new Paging(obj.paging));
            }
        } else {
            super();
            this.setMonth(null);
    ...
    setModifiedTypeFilter(p_modifiedTypeFilter) {
...
class AuUpdateType extends AuDetailsType {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('newCreditCard' in obj) && (obj.newCreditCard != null)) {
                this.setNewCreditCard(new CreditCardMaskedType(obj.newCreditCard));
            }
            if (('oldCreditCard' in obj) && (obj.oldCreditCard != null)) {
                this.setOldCreditCard(new CreditCardMaskedType(obj.oldCreditCard));
            }
        } else {
            super();
    ...
    setNewCreditCard(p_newCreditCard) {
    ...
    setOldCreditCard(p_oldCreditCard) {
...
class GetAUJobDetailsResponse extends ANetApiResponse {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('totalNumInResultSet' in obj) && (obj.totalNumInResultSet != null)) {
                this.setTotalNumInResultSet(obj.totalNumInResultSet);
            }
            if (('auDetails' in obj) && (obj.auDetails != null)) {
                this.setAuDetails(new ListOfAUDetailsType(obj.auDetails));
            }
        } else {
            super();
    ...
    setTotalNumInResultSet(p_totalNumInResultSet) {
    ...
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('subscriptionId' in obj) && (obj.subscriptionId != null)) {
                this.setSubscriptionId(obj.subscriptionId);
            }
            if (('subscription' in obj) && (obj.subscription != null)) {
                this.setSubscription(new ARBSubscriptionType(obj.subscription));
            }
        } else {
            super();
            this.setSubscriptionId(null);
    ...
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('paymentProfiles' in obj) && (obj.paymentProfiles != null)) {
                this.setPaymentProfiles(new ArrayOfCustomerPaymentProfileListItemType(obj.paymentProfiles));
            }
        } else {
            super();
            this.setTotalNumInResultSet(null);
...
class UpdateSplitTenderGroupRequest extends ANetApiRequest {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('splitTenderStatus' in obj) && (obj.splitTenderStatus != null)) {
                this.setSplitTenderStatus(obj.splitTenderStatus);
            }
        } else {
            super();
            this.setSplitTenderId(null);
    ...
    setSplitTenderStatus(p_splitTenderStatus) {
...
class GetHostedProfilePageRequest extends ANetApiRequest {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('hostedProfileSettings' in obj) && (obj.hostedProfileSettings != null)) {
                this.setHostedProfileSettings(new ArrayOfSetting(obj.hostedProfileSettings));
            }
        } else {
            super();
            this.setCustomerProfileId(null);
    ...
    setHostedProfileSettings(p_hostedProfileSettings) {
        this.hostedProfileSettings = p_hostedProfileSettings;
    }

    getHostedProfileSettings() {
...
class CreateCustomerProfileTransactionRequest extends ANetApiRequest {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            super(obj);
            if (('transaction' in obj) && (obj.transaction != null)) {
                this.setTransaction(new ProfileTransactionType(obj.transaction));
            }
            if (('extraOptions' in obj) && (obj.extraOptions != null)) {
                this.setExtraOptions(obj.extraOptions);
            }
        } else {
            super();
            this.setTransaction(null);
    ...
    setExtraOptions(p_extraOptions) {
...
class CreateCustomerPaymentProfileRequest extends ANetApiRequest {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('paymentProfile' in obj) && (obj.paymentProfile != null)) {
                this.setPaymentProfile(new CustomerPaymentProfileType(obj.paymentProfile));
            }
            if (('validationMode' in obj) && (obj.validationMode != null)) {
                this.setValidationMode(obj.validationMode);
            }
        } else {
            super();
            this.setCustomerProfileId(null);
    ...
    setValidationMode(p_validationMode) {
...
class CreateCustomerProfileTransactionResponse extends ANetApiResponse {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('transactionResponse' in obj) && (obj.transactionResponse != null)) {
                this.setTransactionResponse(new TransactionResponse(obj.transactionResponse));
            }
            if (('directResponse' in obj) && (obj.directResponse != null)) {
                this.setDirectResponse(obj.directResponse);
            }
        } else {
            super();
    ...
    setTransactionResponse(p_transactionResponse) {
    ...
    setDirectResponse(p_directResponse) {
...
class CreditCardType extends CreditCardSimpleType {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('isPaymentToken' in obj) && (obj.isPaymentToken != null)) {
                this.setIsPaymentToken(obj.isPaymentToken);
            }
            if (('cryptogram' in obj) && (obj.cryptogram != null)) {
                this.setCryptogram(obj.cryptogram);
            }
        } else {
            super();
            this.setCardCode(null);
    ...
    setIsPaymentToken(p_isPaymentToken) {
...
class GetCustomerProfileResponse extends ANetApiResponse {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            super(obj);
            if (('profile' in obj) && (obj.profile != null)) {
                this.setProfile(new CustomerProfileMaskedType(obj.profile));
            }
            if (('subscriptionIds' in obj) && (obj.subscriptionIds != null)) {
                this.setSubscriptionIds(new SubscriptionIdList(obj.subscriptionIds));
            }
        } else {
            super();
            this.setProfile(null);
    ...
    setSubscriptionIds(p_subscriptionIds) {
...
class GetCustomerPaymentProfileRequest extends ANetApiRequest {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('unmaskExpirationDate' in obj) && (obj.unmaskExpirationDate != null)) {
                this.setUnmaskExpirationDate(obj.unmaskExpirationDate);
            }
        } else {
            super();
            this.setCustomerProfileId(null);
    ...
    setUnmaskExpirationDate(p_unmaskExpirationDate) {
        this.unmaskExpirationDate = p_unmaskExpirationDate;
    }

    getUnmaskExpirationDate() {
...
class MobileDeviceRegistrationRequest extends ANetApiRequest {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('mobileDevice' in obj) && (obj.mobileDevice != null)) {
                this.setMobileDevice(new MobileDeviceType(obj.mobileDevice));
            }
        } else {
            super();
    ...
    setMobileDevice(p_mobileDevice) {
...
class DecryptPaymentDataResponse extends ANetApiResponse {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('shippingInfo' in obj) && (obj.shippingInfo != null)) {
                this.setShippingInfo(new CustomerAddressType(obj.shippingInfo));
            }
            if (('billingInfo' in obj) && (obj.billingInfo != null)) {
                this.setBillingInfo(new CustomerAddressType(obj.billingInfo));
            }
            if (('cardInfo' in obj) && (obj.cardInfo != null)) {
                this.setCardInfo(new CreditCardMaskedType(obj.cardInfo));
            }
            if (('paymentDetails' in obj) && (obj.paymentDetails != null)) {
                this.setPaymentDetails(new PaymentDetails(obj.paymentDetails));
            }
        } else {
            super();
    ...
    setShippingInfo(p_shippingInfo) {
    ...
    setPaymentDetails(p_paymentDetails) {
...
class GetCustomerPaymentProfileResponse extends ANetApiResponse {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            super(obj);
            if (('paymentProfile' in obj) && (obj.paymentProfile != null)) {
                this.setPaymentProfile(new CustomerPaymentProfileMaskedType(obj.paymentProfile));
            }
        } else {
            super();
            this.setPaymentProfile(null);
...
class CreateTransactionRequest extends ANetApiRequest {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('transactionRequest' in obj) && (obj.transactionRequest != null)) {
                this.setTransactionRequest(new TransactionRequestType(obj.transactionRequest));
            }
        } else {
            super();
    ...
    setTransactionRequest(p_transactionRequest) {
...
class GetCustomerShippingAddressResponse extends ANetApiResponse {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            super(obj);
            if (('address' in obj) && (obj.address != null)) {
                this.setAddress(new CustomerAddressExType(obj.address));
            }
            if (('subscriptionIds' in obj) && (obj.subscriptionIds != null)) {
                this.setSubscriptionIds(new SubscriptionIdList(obj.subscriptionIds));
            }
...
class CreateCustomerPaymentProfileResponse extends ANetApiResponse {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('validationDirectResponse' in obj) && (obj.validationDirectResponse != null)) {
                this.setValidationDirectResponse(obj.validationDirectResponse);
            }
        } else {
            super();
            this.setCustomerProfileId(null);
    ...
    setValidationDirectResponse(p_validationDirectResponse) {
        this.validationDirectResponse = p_validationDirectResponse;
    }

    getValidationDirectResponse() {
...
class SecurePaymentContainerRequest extends ANetApiRequest {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            super(obj);
            if (('data' in obj) && (obj.data != null)) {
                this.setData(new WebCheckOutDataType(obj.data));
            }
        } else {
            super();
            this.setData(null);
...
class CreateCustomerProfileRequest extends ANetApiRequest {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            super(obj);
            if (('profile' in obj) && (obj.profile != null)) {
                this.setProfile(new CustomerProfileType(obj.profile));
            }
            if (('validationMode' in obj) && (obj.validationMode != null)) {
                this.setValidationMode(obj.validationMode);
            }
...
class SendCustomerTransactionReceiptRequest extends ANetApiRequest {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('customerEmail' in obj) && (obj.customerEmail != null)) {
                this.setCustomerEmail(obj.customerEmail);
            }
            if (('emailSettings' in obj) && (obj.emailSettings != null)) {
                this.setEmailSettings(new EmailSettingsType(obj.emailSettings));
            }
        } else {
            super();
            this.setTransId(null);
    ...
    setCustomerEmail(p_customerEmail) {
    ...
    setEmailSettings(p_emailSettings) {
    ...
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('batchList' in obj) && (obj.batchList != null)) {
                this.setBatchList(new ArrayOfBatchDetailsType(obj.batchList));
            }
        } else {
            super();
...
class CreateCustomerShippingAddressRequest extends ANetApiRequest {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('address' in obj) && (obj.address != null)) {
                this.setAddress(new CustomerAddressType(obj.address));
            }
        } else {
            super();
            this.setCustomerProfileId(null);
...
class UpdateCustomerProfileRequest extends ANetApiRequest {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            super(obj);
            if (('profile' in obj) && (obj.profile != null)) {
                this.setProfile(new CustomerProfileExType(obj.profile));
            }
        } else {
            super();
            this.setProfile(null);
    ...
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('searchType' in obj) && (obj.searchType != null)) {
                this.setSearchType(obj.searchType);
            }
            if (('month' in obj) && (obj.month != null)) {
                this.setMonth(obj.month);
            }
            if (('sorting' in obj) && (obj.sorting != null)) {
                this.setSorting(new CustomerPaymentProfileSorting(obj.sorting));
            }
            if (('paging' in obj) && (obj.paging != null)) {
                this.setPaging(new Paging(obj.paging));
            }
...
class ProfileTransRefundType extends ProfileTransAmountType {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('creditCardNumberMasked' in obj) && (obj.creditCardNumberMasked != null)) {
                this.setCreditCardNumberMasked(obj.creditCardNumberMasked);
            }
            if (('bankRoutingNumberMasked' in obj) && (obj.bankRoutingNumberMasked != null)) {
                this.setBankRoutingNumberMasked(obj.bankRoutingNumberMasked);
            }
            if (('bankAccountNumberMasked' in obj) && (obj.bankAccountNumberMasked != null)) {
                this.setBankAccountNumberMasked(obj.bankAccountNumberMasked);
            }
            if (('order' in obj) && (obj.order != null)) {
                this.setOrder(new OrderExType(obj.order));
            }
    ...
    setCreditCardNumberMasked(p_creditCardNumberMasked) {
    ...
    setBankRoutingNumberMasked(p_bankRoutingNumberMasked) {
    ...
    setBankAccountNumberMasked(p_bankAccountNumberMasked) {
...
class ARBGetSubscriptionListResponse extends ANetApiResponse {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('subscriptionDetails' in obj) && (obj.subscriptionDetails != null)) {
                this.setSubscriptionDetails(new ArrayOfSubscription(obj.subscriptionDetails));
            }
        } else {
            super();
            this.setTotalNumInResultSet(null);
    ...
    setSubscriptionDetails(p_subscriptionDetails) {
...
class OrderExType extends OrderType {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('purchaseOrderNumber' in obj) && (obj.purchaseOrderNumber != null)) {
                this.setPurchaseOrderNumber(obj.purchaseOrderNumber);
            }
        } else {
            super();
    ...
    setPurchaseOrderNumber(p_purchaseOrderNumber) {
...
class GetSettledBatchListRequest extends ANetApiRequest {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('includeStatistics' in obj) && (obj.includeStatistics != null)) {
                this.setIncludeStatistics(obj.includeStatistics);
            }
            if (('firstSettlementDate' in obj) && (obj.firstSettlementDate != null)) {
                this.setFirstSettlementDate(obj.firstSettlementDate);
            }
            if (('lastSettlementDate' in obj) && (obj.lastSettlementDate != null)) {
                this.setLastSettlementDate(obj.lastSettlementDate);
            }
        } else {
            super();
    ...
    setIncludeStatistics(p_includeStatistics) {
    ...
    setFirstSettlementDate(p_firstSettlementDate) {
    ...
    setLastSettlementDate(p_lastSettlementDate) {
...
class ARBGetSubscriptionListRequest extends ANetApiRequest {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('sorting' in obj) && (obj.sorting != null)) {
                this.setSorting(new ARBGetSubscriptionListSorting(obj.sorting));
            }
            if (('paging' in obj) && (obj.paging != null)) {
                this.setPaging(new Paging(obj.paging));
            }
...
class CreateCustomerProfileResponse extends ANetApiResponse {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('validationDirectResponseList' in obj) && (obj.validationDirectResponseList != null)) {
                this.setValidationDirectResponseList(new ArrayOfString(obj.validationDirectResponseList));
            }
        } else {
            super();
            this.setCustomerProfileId(null);
    ...
    setValidationDirectResponseList(p_validationDirectResponseList) {
...
class CreateCustomerProfileFromTransactionRequest extends ANetApiRequest {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('customer' in obj) && (obj.customer != null)) {
                this.setCustomer(new CustomerProfileBaseType(obj.customer));
            }
            if (('customerProfileId' in obj) && (obj.customerProfileId != null)) {
                this.setCustomerProfileId(obj.customerProfileId);
            }
...
class CustomerPaymentProfileMaskedType extends CustomerPaymentProfileBaseType {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('driversLicense' in obj) && (obj.driversLicense != null)) {
                this.setDriversLicense(new DriversLicenseMaskedType(obj.driversLicense));
            }
            if (('taxId' in obj) && (obj.taxId != null)) {
                this.setTaxId(obj.taxId);
            }
...
class CreateTransactionResponse extends ANetApiResponse {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('profileResponse' in obj) && (obj.profileResponse != null)) {
                this.setProfileResponse(new CreateProfileResponse(obj.profileResponse));
            }
        } else {
            super();
            this.setTransactionResponse(null);
    ...
    setProfileResponse(p_profileResponse) {
...
class UpdateCustomerPaymentProfileRequest extends ANetApiRequest {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('paymentProfile' in obj) && (obj.paymentProfile != null)) {
                this.setPaymentProfile(new CustomerPaymentProfileExType(obj.paymentProfile));
            }
            if (('validationMode' in obj) && (obj.validationMode != null)) {
                this.setValidationMode(obj.validationMode);
            }
...
class ARBGetSubscriptionResponse extends ANetApiResponse {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            super(obj);
            if (('subscription' in obj) && (obj.subscription != null)) {
                this.setSubscription(new ARBSubscriptionMaskedType(obj.subscription));
            }
        } else {
            super();
            this.setSubscription(null);
...
class SubscriptionCustomerProfileType extends CustomerProfileExType {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('shippingProfile' in obj) && (obj.shippingProfile != null)) {
                this.setShippingProfile(new CustomerAddressExType(obj.shippingProfile));
            }
        } else {
            super();
            this.setPaymentProfile(null);
    ...
    setShippingProfile(p_shippingProfile) {
...
class ProfileTransCaptureOnlyType extends ProfileTransOrderType {
    constructor(obj) {
        ...
        if (arguments.length == 1) {
            ...
            if (('approvalCode' in obj) && (obj.approvalCode != null)) {
                this.setApprovalCode(obj.approvalCode);
            }
        } else {
            super();
    ...
    setApprovalCode(p_approvalCode) {
